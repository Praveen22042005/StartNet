...
export default function EntrepreneurSidebar({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { path: '/entrepreneur/home', icon: <HomeIcon className="w-5 h-5" />, text: 'Home' },
    { path: '/entrepreneur/profile', icon: <IdCardIcon className="w-5 h-5" />, text: 'Profile' },
    { path: '/entrepreneur/startups', icon: <RocketIcon className="w-5 h-5" />, text: 'Startups' },
    { path: '/entrepreneur/investors', icon: <PersonIcon className="w-5 h-5" />, text: 'Investors' },
    { path: '/entrepreneur/settings', icon: <GearIcon className="w-5 h-5" />, text: 'Settings' },
  ];
      ...
      >
        ...
        <div className="h-16 border-b border-gray-200 flex items-center justify-between relative">
          <div className="flex items-center pl-3 sidebar-logo">
            <Link href="/entrepreneur/home" className="flex items-center">
